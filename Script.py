...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b>🗂FileName : <code>{file_name}</code>       🏷FileSize : <code>{file_size}</code>           ╔════ 🔰𝐉𝐨𝐢𝐧 𝐖𝐢𝐭𝐡 𝐔𝐬🔰 ════╗▫️<a href=t.me/SAM_DUB_LEZHa>🗽𝐌𝐚𝐢𝐧 𝐇𝐮𝐛</a>▫️<a href=t.me/SAM_DUB_LEEZZA>♻️𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐆𝐫𝐨𝐮𝐩☔​</a>╚════ 🦞𝐉𝐨𝐢𝐧 𝐖𝐢𝐭𝐡 𝐔𝐬🥀 ════╝</b>""" 
